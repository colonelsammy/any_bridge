...
namespace AnyComparisonUnitTests
{
    TEST_CASE("Object without comparison operators doesn't compile","")
    {
        ...
        typedef ab::not_comparable Comparable;
        typedef ab::any<Interface, Comparable> Any;
    ...
    {
        typedef TestInterface1 Interface;
        typedef ab::less_than_comparable Comparable;
        typedef ab::any<Interface, Comparable> Any;
    ...
    {
        typedef TestInterface1 Interface;
        typedef ab::equality_comparable Comparable;
        typedef ab::any<Interface, Comparable> Any;
    ...
    {
        typedef TestInterface1 Interface;
        typedef ab::less_than_equals_comparable Comparable;
        typedef ab::any<Interface, Comparable> Any;
