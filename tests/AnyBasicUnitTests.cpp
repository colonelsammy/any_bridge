...
namespace AnyBasicUnitTests
{
    ...
    {
        ab::any<TestInterface1> a(42);
        ab::any<TestInterface1> b(666);
        ab::any<TestInterface1> c(a);
        REQUIRE(a == c);
        REQUIRE(a != b);
        REQUIRE(b != c);
        REQUIRE(a < b);
    ...
    {
        typedef ab::any<TestInterface2> Any;
